...
?>
	<div class="card-panel">
		...
		<?php else: ?>
		<p class="flow-text"><?php _e("Inserisci il tuo indirizzo e-mail istituzionale. Riceverai le istruzioni per e-mail.") ?></p>
		<form method="post">
			<div class="row">
				<div class="col s12 m6">
					<input type="email" name="uid" id="uid" class="validate" required />
					<label for="uid"><?php _e("Inserisci la tua mail") ?></label>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m6">
