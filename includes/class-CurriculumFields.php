...
class CurriculumFields {
	static function get() {
		...
		$fields = [
			...
			new CSVHeadingSimple(0, 0, 0, 'Curriculum::EMAIL',                              _("e-mail") ),
			new CSVHeadingSimple(1, 0, 0, 'Curriculum::YEARS',                              _("esperienza") ),
			...
			new CSVHeadingSimple(1, 1, 0, 'Curriculum::COURSES_ORGANIZED_SPECIALIZED',      _("corsi specialistici organizzati") ),
			new CSVHeadingSimple(0, 0, 1, 'Curriculum::COURSES_ORGANIZED_SPECIALIZED_DESC', $extra_info),
			new CSVHeadingSimple(1, 1, 0, 'Curriculum::COURSES_ORGANIZED_GENERIC',          _("corsi generici organizzati") ),
			new CSVHeadingSimple(0, 0, 1, 'Curriculum::COURSES_ORGANIZED_GENERIC_DESC',     $extra_info),
			new CSVHeadingSimple(1, 0, 0, 'Curriculum::USRMIUR_TASKS',                      _("gruppi lavoro USR/MIUR") ),
			new CSVHeadingSimple(0, 0, 1, 'Curriculum::USRMIUR_TASKS_DESC',                 $extra_info),
			new CSVHeadingSimple(1, 0, 0, 'Curriculum::REGIONAL_TASK',                      _("gruppi lavoro regionali/provinciali") ),
